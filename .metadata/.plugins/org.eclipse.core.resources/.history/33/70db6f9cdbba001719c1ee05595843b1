// https://gwt.googlesource.com/gwt/+/b89865bf7af9e9f80ee5b48a7f64f5fe95ce5974/user/src/com/google/gwt/user/client/impl/HTTPRequestImpl.java
...
public class HTTPRequestImpl {
  ...
  private native boolean asyncGetImpl(String user, String pwd, String url,
      ResponseTextHandler handler) /*-{
    var xmlHttp = this.@chapter9.httprequestimpl.client.HTTPRequestImpl::doCreateXmlHTTPRequest()();
    try {
      xmlHttp.open("GET", url, true);
      xmlHttp.setRequestHeader("Content-Type", "text/plain; charset=utf-8");
      xmlHttp.onreadystatechange = function() {
        if (xmlHttp.readyState == 4) {
          xmlHttp.onreadystatechange = @chapter9.httprequestimpl.client.HTTPRequestImpl::nullFunc;
