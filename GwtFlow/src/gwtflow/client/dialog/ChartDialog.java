...
import gwtflow.client.FlowViewContainer;
...
public class ChartDialog extends Dialog {
	...
	public void show() {
		...
		FlowViewContainer.getInstance().show(
				chartPanel.el().getX() + 1,
				chartPanel.el().getY() + 1,
				chartPanel.el().getWidth() - 2,
				chartPanel.el().getHeight() - 2,
				taskId);
	}
	
	@Override
	public void hide(Button buttonPressed) {
		FlowViewContainer.getInstance().hide();
